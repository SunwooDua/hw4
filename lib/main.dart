    ...
    return Form(
      ...
      child: Column(
        ...
        children: <Widget>[
          Container(
            child: Text(
              'After registration (above), sign in below using correct email and pswd',
            ),
...
class Setting extends StatefulWidget {
  ...
  Setting({required this.userEmail, required this.auth});
            ...
            ListTile(
              ...
              onTap: () {
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder:
                        (context) => Setting(userEmail: userEmail, auth: auth),
                  ),
                );
              },
            ),
